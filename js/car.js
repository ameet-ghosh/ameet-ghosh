...
var interval_car_1 = setInterval(function () {
    app.traffic_car_1();
}, 3000);

var interval_car_2 = setInterval(function () {
    app.traffic_car_2();
}, 8000);


var fuelTank = setInterval(function () {
    app.fuel_tank();
}, 35000);
var oilSpill = setInterval(function () {
    app.oil_spill();
}, 10000);
